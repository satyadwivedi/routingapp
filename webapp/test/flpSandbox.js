		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsatyaroutingapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsatyaroutingapp-display": {
								"semanticObject": "comsatyaroutingapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.satya.routingapp",
									"url": sap.ui.require.toUrl("com/satya/routingapp")
								}
							}
						}
					}
